...
keymap.set("n", "<leader>gs", "<cmd>Gstatus<CR>", { desc = "Git status" }, o)
keymap.set("n", "<leader>gd", "<cmd>Gdiffsplit<CR>", { desc = "Show different in split" }, o)
keymap.set("n", "<leader>gc", "<cmd>Gcommit<CR>", { desc = "Git commit" }, o)
keymap.set("n", "<leader>gp", "<cmd>Gpush<CR>", { desc = "Git push" }, o)
keymap.set("n", "<leader>gl", "<cmd>Gpull<CR>", { desc = "Git pull" }, o)
keymap.set("n", "<leader>gwr", "<cmd>Gwrite<CR>", { desc = "Git add / write" }, o)
--- End Git Area
