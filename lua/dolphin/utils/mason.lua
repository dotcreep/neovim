...
local configurations = { -- Konfigurasi untuk berbagai bahasa dan tools
	...
	{ "go", "gopls", "golangcilint", "delve", "gofumpt" }, -- Golang
	...
	{ "java", "kotlin-language-server", "ktlint", "kotlin-debug-adapter", "ktfmt" }, -- Kotlin
	...
	{ "node", "yamlls", "sonarlint-language-server", nil, "prettier" }, -- YAML
}
